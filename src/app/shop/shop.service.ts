...
export class ShopService {
  ...
  getTypes() {
    ...
    return this.http.post<IType[]>(this.baseUrl + `products/types`,null).pipe(
      map(response => {
        this.types = response;
        console.log("product type", this.types);
        return response;
      })
    );
  }
  ...
  getBrands() {
    ...
    return this.http.post<IBrand[]>(this.baseUrl + `products/brands`,null).pipe(
      map(response => {
